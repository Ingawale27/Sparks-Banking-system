...
{
  if (!$con->query("insert into useraccounts (name,AdhaarNo,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[AdhaarNo]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        <tr>
          ...
          <th>AdhaarNo</th>
          <td><input type="number" name="AdhaarNo" class="form-control input-sm" required></td>
        </tr>
        <tr>
