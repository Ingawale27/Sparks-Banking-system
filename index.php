...
<body style="background:#DA70D6;background-size: 100%">
...
<div class="row w-100" >
  <div class="col" style="padding: 22px;padding-top: 0">
    <div class="jumbotron shadowPink" style="padding: 25px;min-height: 241px;max-height: 241px">
  <h4 class="display-35">Welcome to OBC Bank</h4>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/img6.jpg" alt="First slide" style="max-height: 300px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/img7.jpg" alt="Second slide" style="max-height: 300px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/img8.jpg" alt="Third slide" style="max-height: 300px">
          </div>
...
<div class="row" style="padding: 22px;padding-bottom: 5px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top w-100" src="images/contacts.gif" alt="Card image cap" style="max-height: 200px;min-height: 200px">
        <div class="card-body">
