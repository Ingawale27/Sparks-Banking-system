...
<head>
    ...
    define('bankName', 'Sparks Project : OBC Bank',true);
...
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Ashwini Ingawale</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowblue" style="margin-right: 222px">
	<br><h4 class="text-center text-Pink">Select Your Session</h4>
  <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="ashwini@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="ashwini12" class="form-control" required placeholder="Enter Password">
